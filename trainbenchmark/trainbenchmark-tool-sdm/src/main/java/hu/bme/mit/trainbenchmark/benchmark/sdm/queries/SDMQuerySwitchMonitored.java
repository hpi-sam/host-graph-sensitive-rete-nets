...
public class SDMQuerySwitchMonitored extends SDMQuery<EmfSwitchMonitoredMatch> {

	public SDMQuerySwitchMonitored(SDMDriver driver) {
		super(RailwayQuery.SWITCHMONITORED, driver);
	}

	@Override
	protected String getPatternName() {
		return "SwitchMonitored";
	}

	@Override
	protected EmfSwitchMonitoredMatch encodeTuple(ReteTuple tuple) {
		EmfSwitchMonitoredMatch match = new EmfSwitchMonitoredMatch((Switch) tuple.get(0));
		return match;
	}
