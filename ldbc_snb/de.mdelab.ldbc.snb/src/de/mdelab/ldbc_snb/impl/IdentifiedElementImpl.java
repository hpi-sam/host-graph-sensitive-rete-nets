 ...
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.ldbc_snb.impl.IdentifiedElementImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifiedElementImpl extends MinimalEObjectImpl.Container implements IdentifiedElement {
	...
	protected EClass eStaticClass() {
		return Ldbc_snbPackage.Literals.IDENTIFIED_ELEMENT;
	}
	...
	public void setID(long newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ldbc_snbPackage.IDENTIFIED_ELEMENT__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ldbc_snbPackage.IDENTIFIED_ELEMENT__ID:
				return getID();
		}
