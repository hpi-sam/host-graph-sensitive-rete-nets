...
public class ExecuteStaticIncremental {
	...
	public static void main(String args[]) throws IOException, SDMException {
		...
		StaticIncrementalExecutor executor = new StaticIncrementalExecutor();
		executor.executeIncremental(logReader, queryManager, logger, logMem, dataFile, pattern);
	}
	...
	private static void warmUp(String dataFile, String ruleFile) throws IOException, SDMException {
		...
		DynamicReteQueryManager reteNet = new StaticNetQueryManager(pattern);
